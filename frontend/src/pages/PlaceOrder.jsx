...
const PlaceOrder = () => {
  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vw] border-t'>
      {/* -------- left Side -------- */}
      ...
      <div className='mt-8'>
        ...
        <div className='mt-12'>
          <Title text1={'PAYMENT'} text2={'METHDD'} />
